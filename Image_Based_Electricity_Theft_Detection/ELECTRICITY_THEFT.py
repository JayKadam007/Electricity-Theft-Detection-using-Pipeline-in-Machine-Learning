...
os.environ['GOOGLE_APPLICATION_CREDENTIALS']='D:/Electricity_Theft_Detection/Image_Based_Electricity_Theft_Detection/endless-dialect-381605-76f3aefca43d.json'
...
def Choose():
    global file
    file = askopenfilename(initialdir=r'D:/Final code/Electricity_Theft_Detection/Image_Based_Electricity_Theft_Detection/DATA_SET', title='Select Image',
...
def Check():
    global file
    data = pd.read_csv(r"D:/Electricity_Theft_Detection/Image_Based_Electricity_Theft_Detection/data1.csv")
    data.dropna()  
